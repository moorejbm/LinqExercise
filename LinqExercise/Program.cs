...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Sum and Average of numbers:");
            var sum = numbers.Sum();
            var avg = numbers.Average();
            Console.WriteLine($"Sum equals: {sum} Avareage equals: {avg}");
            ...
            //Change the value at index 4 to your age, then print the numbers in decsending order // ***Look at***
            Console.WriteLine("-----------------------------");
            ...
            var employees = CreateEmployees(); //****Need to Look at****
            ...
            Console.WriteLine("-----------------------------");
            Console.WriteLine("Employees first name starts with C or S:");
            ...
            {
                Console.WriteLine($" Age: {person.Age} First Name: {person.FirstName} YOE: {person.YearsOfExperience}");
            }
            ...
            //Add an employee to the end of the list without using employees.Add() //***Need to Look AT 
            ...
            private static List<Employee> CreateEmployees()  //***Need to Look at****
            {
